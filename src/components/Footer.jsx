...
export default function Footer() {
  return (
    <footer className="bg-theme-footer text-slate-300 py-12 mt-auto text-sm border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        {/* Right Section: Dynamic Institutes List (Spans 2 columns) */}
            ...
            {institutes.map((inst, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Formatted to match your image: "Full Name (Short Name)" */}
